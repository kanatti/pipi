// Original: https://github.com/mitsuhiko/agent-stuff/blob/main/pi-extensions/whimsical.ts
import type { ExtensionAPI } from "@mariozechner/pi-coding-agent";

const messages = [
  // Tech-flavored long phrases
  "Consulting the void...",
  ...
  "Appeasing lifetimes...",
  "Convincing rustc...",
  "Sweet-talking unsafe blocks...",
  "Massaging trait bounds...",
  "Bribing the type system...",
  "Wrangling ownership semantics...",
  "Coaxing the compiler...",
  "Reasoning with References...",
  "Pleading with Pin...",
  "Cajoling Copy traits...",
  "Having words with Send and Sync...",

  // Technical - Search (Lucene/Tantivy)
  "Whispering to term vectors...",
  "Schmoozing with posting lists...",
  "Wrangling inverted indices...",
  "Tickling BM25 scores...",
  "Herding TF-IDF weights...",
  "Massaging token analyzers...",
  "Consulting the term dictionary...",
  "Negotiating with segment merges...",
  "Appeasing the doc store...",
  "Convincing field norms...",
  "Sweet-talking proximity queries...",

  // Technical - OpenSearch/Elasticsearch
  "Negotiating with primaries...",
  "Appeasing the shard allocator...",
  "Convincing replicas to agree...",
  "Massaging cluster state...",
  "Bribing the master node...",
  "Sweet-talking the translog...",
  "Wrangling shard routing...",
  "Herding recovery threads...",
  "Reasoning with refresh intervals...",
  "Coaxing segment merges...",
  "Pleading with the circuit breaker...",
  "Having words with node filters...",
  "Consulting cluster health...",
  "Cajoling bulk indexers...",

  // Technical - K8s/Distributed
  "Consulting the etcd oracle...",
  "Pleading with the scheduler...",
  "Reasoning with ReplicaSets...",
  "Having words with the kubelet...",
  "Negotiating with the API server...",
  "Appeasing the control plane...",
  "Convincing pods to reschedule...",
  "Massaging node affinity...",
  "Bribing the ingress controller...",
  "Wrangling StatefulSets...",
  "Herding DaemonSets...",
  "Sweet-talking service meshes...",
  "Coaxing the CNI plugin...",

  // Technical - DataFusion/Query Engines
  "Optimizing query plans...",
  "Massaging logical plans...",
  "Negotiating with the optimizer...",
  "Convincing physical planners...",
  "Wrangling execution graphs...",
  "Herding partition pruning...",
  "Reasoning with predicate pushdown...",
  "Appeasing the cost model...",
  "Consulting column statistics...",

  // Kerala/Thrissur vibes
  "Climbing coconut trees...",
  "Consulting coconut wisdom...",
  "Harvesting coconut thoughts...",
  "Shaking coconut palms...",
  "Husking possibilities...",
  "Grating fresh ideas...",
  "Consulting the chaya kada oracle...",
  "Brewing some chaya...",
  "Waiting for the sadya...",
  "Arranging banana leaves...",
  "Serving payasam thoughts...",
  "Pouring avial wisdom...",
  "Ladling some sambar logic...",
  "Rolling appam solutions...",
  "Waiting for the monsoon...",
  "Dancing in the pre-monsoon...",
  "Listening to rain on tin roofs...",
  "Watching the downpour...",
  "Wading through paddy fields...",
  "Transplanting ideas...",
  "Making pookalam patterns...",
  "Arranging flower carpets...",
  "Preparing for Onam...",
  "Pinne, thinking...",
  "Sheri, processing...",
  "Adipoli computing...",
  ...
  "Kintoki processing...",
  "Neo Armstrong Cyclone Jet Armstrong Cannon-ing...",
  "Researching obscure magic...",
  "Checking for mimics...",
